...
# Create a smaller figure for the class performance bar graph
# Reduced from 20x10 to 10x6 inches for a more compact representation
...
# Use smaller font size for x-tick labels
plt.xticks(x, disease_classes, rotation=90, fontsize=8)
plt.ylim(0, 1.0)
...
# Save the figure
output_path = 'c:\\Users\\Dell\\OneDrive\\Desktop\\Enhancing_crop_disease_detection\\yolo_visualizations\\small_class_performance_graph.svg'
plt.savefig(output_path, format='svg', dpi=300, bbox_inches='tight')
print(f"Small class performance graph saved to {output_path}")
